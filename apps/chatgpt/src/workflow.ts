...
const rules: Array<{ terms: string[]; skills: string[]; action: string; reason: string }> = [
  ...
  { terms: ["review", "pull request", "pr", "diff"], skills: ["skills/flutter-dart-code-review"], action: "Inspect history, diff, review findings, and affected files", reason: "Review work should begin with evidence from the PR and its diff." },
  ...
  { terms: ["refactor", "architecture", "modular"], skills: ["skills/agent-architecture-audit"], action: "Map dependencies and propose a bounded refactor", reason: "Refactors need dependency mapping before editing." },
];
