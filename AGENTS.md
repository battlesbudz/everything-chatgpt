# Everything ChatGPT (ECG) — Agent Instructions

This fork adapts the upstream Everything Claude Code operating system for ChatGPT and Codex workflows. Upstream attribution and the MIT license remain intact. Claude-specific integrations are retained only where they are still useful as compatibility adapters; new guidance should treat ChatGPT/Codex as the primary target.

This is a **production-ready AI coding harness** providing specialized agents, reusable skills, commands, and automated workflows for software development.
